...
export const AdminLayoutComponent = (user) => {
    console.log(user)
    if (user) {
    ...
    return (
        <div className="xl:flex-1 xl:flex xl:overflow-y-hidden h-screen">
            Admin
            <section id="sidebar" className="bg-gray-100 xl:w-64 shadow text-gray-600 overflow-y-scroll hidden lg:block">
              <LogoDashboard className="mb-3 mt-3"/>
              <span className="sm:block md:hidden">
                <i className="material-icons">close</i>
              </span>
              <div>
                  <SidebarNavItems sidebar={AdminSidebar}></SidebarNavItems>
              </div>
            </section>
            <main className="xl:flex-1 xl:overflow-x-hidden min-h-screen flex flex-col">
                <header className="bg-gray-900 hidden lg:flex sm:items-center sm:justify-between xl:bg-white xl:flex-shrink-0">
                ...
                <section className="flex-grow">
                    <div className="mobile-header bg-white lg:hidden">
                      <div className={"block text-center lg:hidden py-10 pb-20 text-white " + greetingClass() }>
                        { greetingText() }
                      </div>
                      <div className="block relative w-11/12 m-0 mx-auto lg:hidden rounded overflow-hidden shadow-lg p-5 bg-white -m-10">
                    ...
                    <div className="mobile-news px-5 bg-white mt-2 py-5 h-screen text-sm lg:hidden">
                    ...
                    <div className="mobile-footer w-full pb-1 fixed bottom-0 border-t-2 border-gray-300 bg-white text-sm lg:hidden">
