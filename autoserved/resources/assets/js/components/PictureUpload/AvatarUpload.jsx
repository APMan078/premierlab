  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <div className="w-24 h-24 lg:w-32 lg:h-32 xl:w-48 xl:h-48 rounded-full mb-4 mx-auto relative overflow-hidden pointer-events-none mt-10">
            {isHovering && (
              <div
          ...
          <span className="block text-grey text-sm">
            Drag or click to update your {type} avatar
          </span>
        </DragOverlay>
        <input
          type="file"
