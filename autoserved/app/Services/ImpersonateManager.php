...
use App\Exceptions\AlreadyImpersonatingException;
use App\Exceptions\CantBeImpersonatedException;
use App\Exceptions\CantImpersonateException;
use App\Exceptions\CantImpersonateSelfException;
use App\Exceptions\NotImpersonatingException;
...
class ImpersonateManager
{
    ...
    {
        return config('passport-impersonate.session_key');
    }
    ...
    {
        try {
            $uri = route(config('passport-impersonate.take_redirect_to'));
        } catch (\InvalidArgumentException $e) {
            $uri = config('passport-impersonate.take_redirect_to');
        }
    ...
    {
        try {
            $uri = route(config('passport-impersonate.leave_redirect_to'));
        } catch (\InvalidArgumentException $e) {
            $uri = config('passport-impersonate.leave_redirect_to');
        }
